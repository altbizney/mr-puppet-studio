...
public class MLRotationAxis : Agent
{
    ...
    */
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        RealDelta[0] = Remap(RealDelta[0], 0f, 180f, 0f, 1f);
        RealDelta[1] = Remap(RealDelta[1], 0f, 180f, 0f, 1f);
        RealDelta[2] = Remap(RealDelta[2], 0f, 180f, 0f, 1f);
