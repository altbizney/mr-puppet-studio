...
public class UnityRemoteDebugController : MonoBehaviour
{
    ...
    private void UpdateDebugText(){
        ...
        debugText.text = "Gyro setup: " + rotX + ", " + rotY + ", " + rotZ;
    }
    private void Update()
    {
        ApplyGyroRotation();
    ...
    private void ApplyGyroRotation()
    {
        ...
        _rawGyroRotation.Rotate(rotX, rotY, rotZ, Space.World); // Rotate to make sense as a camera pointing out the back of your device.
