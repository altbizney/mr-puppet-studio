...
namespace MrPuppet
{
    public class PoseSpaceSigned : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            liveXY = Mathf.Atan2(liveForward.x, liveForward.y) * Mathf.Rad2Deg;
            liveYZ = Mathf.Atan2(liveForward.y, liveForward.z) * Mathf.Rad2Deg;

            zeroXZ = Mathf.Atan2(zeroForward.y, zeroForward.z) * Mathf.Rad2Deg;
            zeroXY = Mathf.Atan2(zeroForward.x, zeroForward.y) * Mathf.Rad2Deg;
            zeroYZ = Mathf.Atan2(zeroForward.y, zeroForward.z) * Mathf.Rad2Deg;

            poseNorthSeperated.x = Mathf.Atan2(poseNorthForward.x, poseNorthForward.z) * Mathf.Rad2Deg;
            poseNorthSeperated.y = Mathf.Atan2(poseNorthForward.x, poseNorthForward.y) * Mathf.Rad2Deg;
            poseNorthSeperated.z = Mathf.Atan2(poseNorthForward.y, poseNorthForward.z) * Mathf.Rad2Deg;

            poseSouthSeperated.x = Mathf.Atan2(poseSouthForward.x, poseSouthForward.z) * Mathf.Rad2Deg;
            poseSouthSeperated.y = Mathf.Atan2(poseSouthForward.x, poseSouthForward.y) * Mathf.Rad2Deg;
            poseSouthSeperated.z = Mathf.Atan2(poseSouthForward.y, poseSouthForward.z) * Mathf.Rad2Deg;

            poseEastSeperated.x = Mathf.Atan2(poseEastForward.x, poseEastForward.z) * Mathf.Rad2Deg;
            poseEastSeperated.y = Mathf.Atan2(poseEastForward.x, poseEastForward.y) * Mathf.Rad2Deg;
            poseEastSeperated.z = Mathf.Atan2(poseEastForward.y, poseEastForward.z) * Mathf.Rad2Deg;

            poseWestSeperated.x = Mathf.Atan2(poseWestForward.x, poseWestForward.z) * Mathf.Rad2Deg;
            poseWestSeperated.y = Mathf.Atan2(poseWestForward.x, poseWestForward.y) * Mathf.Rad2Deg;
            poseWestSeperated.z = Mathf.Atan2(poseWestForward.y, poseWestForward.z) * Mathf.Rad2Deg;
            ...
            NorthTotalScore = PopulateScores(poseNorthSeperated);
            SouthTotalScore = PopulateScores(poseSouthSeperated);
            EastTotalScore = PopulateScores(poseEastSeperated);
            WestTotalScore = PopulateScores(poseWestSeperated);
        ...
        private float PopulateScores(Vector3 PoseSeperated)
        {
            float Score;
